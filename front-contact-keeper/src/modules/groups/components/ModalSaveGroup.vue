          ...
          <div class="field">
            <span class="p-float-label p-input-icon-right">
              ...
              <InputText id="field-name" v-model="group.name"
                         :class="{ 'invalid-field-custom': !v$.name.$pending && v$.name.$error }"
                         @input="v$.name.$touch()"/>
          ...
          <div class="field">
            <span class="p-float-label p-input-icon-right">
              ...
              <InputText id="field-title" v-model="group.title"
                         :class="{ 'invalid-field-custom': !v$.title.$pending && v$.title.$error }"
                         @input="v$.title.$touch()"/>
          ...
          <div class="field">
            <span class="p-float-label p-input-icon-right">
              ...
              <b-form-textarea id="field-notes" v-model="group.notes" rows="5"
                               :class="{ 'invalid-field-custom': !v$.notes.$pending && v$.notes.$error }"
                               @input="v$.notes.$touch()"/>
